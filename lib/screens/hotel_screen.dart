...
class _HotelScreenState extends State<HotelScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      height: 350,
      padding: const EdgeInsets.symmetric(horizontal: 15, vertical: 17), /// for inside of the container
      margin: const EdgeInsets.only(right: 17, top: 5), /// for outside of the container
