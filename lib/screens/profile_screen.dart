          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                Gap(AppLayout.getHeight(12)),
                const AppLayoutBuilderWidget(sections: 12, width: 5, height: 1, isColor: false,),
                Gap(AppLayout.getHeight(12)),
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: const [
                ...
                Row(
                  ...
                  children: const [
                    ...
                    AppColumnLayout(firstText: "Omitoful", secondText: "Received from", alignment: CrossAxisAlignment.end)
                  ],
                ),
              ],
            ),
